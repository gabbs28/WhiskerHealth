...
export const thunkLogin = (credentials: LoginCredentials): AppThunk => async (dispatch: AppDispatch) => {
    // Attempt to log in
...
export const thunkSignup = (user: SignupUser): AppThunk => async (dispatch: AppDispatch) => {
...
//define reducer
function sessionReducer(state = initialState, action: ActionCreator<SessionActionTypes, SessionActionPayload>): SessionInitialState {
    switch (action.type) {
